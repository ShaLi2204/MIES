...
class SelfTrackingDisplay extends Component{
    ...
    constructor(props){
        ...
        this.state = {
            ...
            MCOptions: JSON.parse(props.surveyItem.surveyItemOptions || '' ),
                            ...
                            <Form>
                                <FormGroup>
                                    ...
                                    {JSON.parse(surveyItem.surveyItemOptions ||'').map((el, i) => 
                                        <Button key={i} disabled style={{marginRight: '10px'}}>{el}</Button>
                                    )}
                                </FormGroup>
                            </Form>
                        </div>
...
registerComponent({
    name: 'SelfTrackingDisplay',
    component: SelfTrackingDisplay,
