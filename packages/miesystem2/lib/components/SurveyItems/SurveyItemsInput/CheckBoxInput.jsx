...
class CheckBoxInput extends Component{
    ...
    createInputItems() {
        return this.state.values.map((el, i) => 
            <div key={i}>
                <InputGroup>
                    <Input value={el||''} onChange={this.getSurveyItemOptions.bind(this, i)} placeholder="Please input an option"/>
    ...
    render(){
        ...
        return(
            <div className="MultipleChoiceInputPage">
                <Form>
                    <FormGroup>
                        <Input onChange={this.getSurveyItemOptionsI.bind(this)} placeholder="Please input an option"/>
                    </FormGroup>
                    <FormGroup>
                        <Input onChange={this.getSurveyItemOptionsII.bind(this)} placeholder="Please input an option"/>
                    </FormGroup>
