...
const OpenSurveysQuestionThread = (props) => {
    ...
    if(loading) {
        ...
        return(
            <div>
                <Components.OSSurveyItemList currentUser={currentUser} surveyItems={resultsClone} surveyItemCount={totalCount} surveyList={surveyList} /*surveyResponseId={surveyResponseId}*//>
            </div>
        )
    }
};
