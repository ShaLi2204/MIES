...
class SearchForm extends Component {
    ...
    delay(() => {
        ...
        if (this.state.pathname === router.location.pathname) {
            router.push({ pathname: '/opensurveys'/* Utils.getRoutePath('posts.list')*/, query: query });
        }
        }, 700);
    }
                ...
                <Components.FormElement>
                    <Components.FormComponentText
                        inputProperties={{
                            ...
                            placeholder: this.context.intl.formatMessage({ id: 'surveyLists.search' }),
                            type: 'text',
                            layout: 'elementOnly',
                    ...
                    />
                    {this.state.search !== '' ? (
                        <Link className="search-form-reset" to={{ pathname: '/opensurveys', query: resetQuery }}>
