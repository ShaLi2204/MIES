...
class SurveyItemCommentBox extends Component{
...
registerComponent({ name: 'SurveyItemCommentBox', component: SurveyItemCommentBox, hocs:[[withUpdate, updateOptions],[withDelete, deleteOptions]] });